...
export class TranslateService {
  ...
  private readonly translations: Record<Language, Record<string, string>> = {
    ...
    mr: {
      ...
      'nav.sabhasadVargani': 'सभासद वरणी',
      ...
      'transactionDetail.special': 'विशेष वरणी',
      'transactionDetail.monthly': 'महिन्यांची वरणी',
